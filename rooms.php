                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <input type="number" id="adults" value="<?php echo $adult_default ?>" oninput="guests_filter()" class="form-control shadow-none" min="1">
                                    </div>
                                    <div>
                                        <label class="form-label">Trẻ em:</label>
                                        <input type="number" id="children" value="<?php echo $children_default ?>" oninput="guests_filter()" class="form-control shadow-none" min="1">
                                    </div>
                                </div>
                            </div>
                        </div>
